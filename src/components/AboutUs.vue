    ...
    <div>
      ...
      <div class="row " id="BoardMembers">
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-3 col-xs-12 ">
              <img class="img-responsive" src="../assets/static/img/Members/XinTao Liu.png">
            </div>
            <div class="col-md-9 col-xs-12 m-center">
              <strong>Dr. Xintao Liu</strong><br>
              <strong>Secretary of MGSC of IGU</strong>
              <p>PhD, Assistant Professor <br>
                The HongKong Polytechnic University, China<br>
                Links: <a href="https://geoxlab.github.io/" target="_blank" style="color: orange;">https://geoxlab.github.io/</a><br>
                Email: <a href="mailto:xintao.liu@polyu.edu.hk" style="color: orange;"> xintao.liu@polyu.edu.hk </a>
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          ...
          <div class="container">
            ...
            <div class="row">
              ...
              <div class="col-md-9 col-xs-12 m-center">
                <strong>Dr. Manish Kumar </strong><br>
                <p>PhD, Assistant Professor<br>
          ...
          <div class="container">
            ...
            <div class="row">
              ...
              <div class="col-md-9 col-xs-12 m-center">
                ...
                <p>PhD<br>
                  HelmHoltz-Centre for Environmental Research, Germany <br>
                  Links: <a href="https://www.ufz.de/index.php?de=38476" target="_blank" style="color: orange;">https://www.ufz.de/index.php?de=38476</a><br>
                  Email: <a href="mailto:erik.nixdorf@ufz.de" style="color: orange;"> erik.nixdorf@ufz.de </a>
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="container">
            ...
            <div class="row">
              ...
              <div class="col-md-9 col-xs-12 m-center">
                <strong>Dr. Karel Stane </strong><br>
                <p>PhD, Assistant Professor<br>
